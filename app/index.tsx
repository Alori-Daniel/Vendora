    ...
    <ScreenShell scrollable>
      <SurfaceCard style={styles.hero} tone="primary">
        ...
        <ThemedText variant="muted">
          Track orders, share invoices, monitor balances, and keep deliveries
          moving from one mobile workspace built for Instagram and WhatsApp
          sellers.
        </ThemedText>
      ...
      <View style={styles.metrics}>
        <MetricCard helper="Designed for fast order capture" label="Goal" tone="brand" value="< 60s" />
        <MetricCard
      ...
      <SurfaceCard>
        ...
        <ThemedText variant="muted">
          Start with Instagram and WhatsApp product sellers. They already feel
          the pain of scattered chats, manual invoicing, and unpaid balances.
        </ThemedText>
      ...
      <SurfaceCard>
        ...
        <View style={styles.featureList}>
          ...
          <ThemedText>Invoices, payment tracking, and dashboard</ThemedText>
